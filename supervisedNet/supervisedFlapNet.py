...
def initNet(n_inputs, n_hidden, n_outputs):
	network = list()
...
network = initNet(n_inputs, 4, n_outputs)

errorLst = trainNet(network, dataset, 0.5, 40, n_outputs)
for layer in network:
	print(layer)
